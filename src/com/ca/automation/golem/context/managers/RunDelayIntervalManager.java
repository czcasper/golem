 ...
 * @author maslu02
 */
public class RunDelayIntervalManager<T> extends AbstractContextManager<T, RunDelayInterval<T>> implements RunDelayIntervalManagerContext<T> {

    /**
     *
     * @param context
     */
    public RunDelayIntervalManager(RunContextImpl<T> context) {
        super(context);
    }
