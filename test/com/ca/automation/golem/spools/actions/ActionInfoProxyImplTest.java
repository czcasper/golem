...
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithAfterInit;
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithAfterRun;
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithAfterValidate;
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithBeforeInit;
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithBeforeRun;
import com.ca.automation.testClasses.actions.dummy.ordering.ActionWithBeforeValidate;
import com.ca.automation.testClasses.actions.dummy.valid.ActionWithConnection;
import com.ca.automation.testClasses.actions.dummy.valid.ActionWithContext;
import com.ca.automation.testClasses.actions.dummy.ActionWithInit;
import com.ca.automation.testClasses.actions.dummy.valid.ActionWithMembers;
import com.ca.automation.testClasses.actions.dummy.valid.ActionWithRetValues;
import com.ca.automation.testClasses.actions.dummy.ActionWithRun;
import com.ca.automation.testClasses.actions.dummy.ActionWithValidate;
import com.ca.automation.testClasses.actions.dummy.valid.ValidActionWithNoRun;
import com.ca.automation.testClasses.actions.wrong.WrongActionNoAnnots;
import com.ca.automation.testClasses.actions.wrong.WrongNoRunMethod;
...
public class ActionInfoProxyImplTest {
    ...
    public void testAddField() {
         ...
         */
        parameterFields = new ArrayList<Field>();
        result = instance.addField(type, parameterFields);
        assertFalse(result);
         ...
         */
        Collection<Field> connectionsField = new ArrayList<Field>();
         ...
         */
        Collection<Field> contextField = new ArrayList<Field>();
         ...
         * Initialize field with expected annotations RunContext.
         */
        Collection<Field> retValuesFields = new ArrayList<Field>();
    ...
    public void testGetField_ActionFieldProxyType() {
        ...
        Collection<Field> contextField = new ArrayList<Field>();
        contextField.addAll(Arrays.asList(ActionWithContext.class.getDeclaredFields()));
        Collection<Field> connectionField = new ArrayList<Field>();
        connectionField.addAll(Arrays.asList(ActionWithConnection.class.getDeclaredFields()));
        Collection<Field> parametrField = new ArrayList<Field>();
    ...
    public void testGetField_String() {
         ...
         * instance.
         */
        List<String> names = new ArrayList<String>(declaredFields.length);
    ...
    public void testAddMethod() {
         ...
         * testing.
         */
        Collection<Method> wrongMethod = new ArrayList<Method>();
         ...
         */
        Collection<Method> initMethod = new ArrayList<Method>();
        initMethod.addAll(Arrays.asList(ActionWithInit.class.getDeclaredMethods()));
        Collection<Method> runMethod = new ArrayList<Method>();
        runMethod.addAll(Arrays.asList(ActionWithRun.class.getDeclaredMethods()));
        Collection<Method> validMethod = new ArrayList<Method>();
